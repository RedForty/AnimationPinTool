...
Usage:
    import animationPinTool
    animationPinTool.show()           # Launch the UI
    animationPinTool.create_pins()    # Create pins via command line
    animationPinTool.bake_pins()      # Bake pins via command line
"""
